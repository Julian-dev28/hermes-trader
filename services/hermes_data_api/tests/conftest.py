...
# --------------------------------------------------------------------------- #
_TMPDIR = tempfile.mkdtemp(prefix="hermes_data_api_test_")
_DB_PATH = os.path.join(_TMPDIR, "test.db")

os.environ["HERMES_DATABASE_URL"] = f"sqlite:///{_DB_PATH}"
os.environ["HERMES_ENV"] = "test"
os.environ["HERMES_LOG_JSON"] = "false"          # human-readable test logs
...
os.environ["HERMES_RATE_LIMIT_PER_MIN"] = "120"
os.environ["HERMES_RATE_LIMIT_BURST"] = "30"
...
os.environ.pop("HERMES_OPTIONS_FLOW_UPSTREAM", None)
