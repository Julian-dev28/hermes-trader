"""Pathia Data API — application factory. Wires config, logging, DB, middleware,
...
logger = logging.getLogger("pathia.main")
...
def create_app() -> FastAPI:
    ...
    logger.info("pathia-data-api ready", extra={"extra_fields": {"env": s.env, "version": s.version}})
    return app
