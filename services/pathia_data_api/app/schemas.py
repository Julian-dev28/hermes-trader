"""Pydantic response/request models for the Pathia Data API.
...
# Run: python -m services.pathia_data_api.app.schemas
# ---------------------------------------------------------------------------
if __name__ == "__main__":  # pragma: no cover
    ...
    hr = HealthResponse(status="ok", service="pathia-data-api", version="0.1.0", env="dev")
