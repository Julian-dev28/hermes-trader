...
def _policy(cfg, noise_band=False, noise_band_atr_mult=1.0):
    ...
    return ExitPolicy(
        ...
        max_loss_pct=d.get("max_loss_pct", 3.5),
        max_loss_roe_pct=d.get("max_loss_roe_pct", 18.0),
        protect_pct=d.get("protect_pct", 1.0),
        retrace_threshold=d.get("retrace_threshold", 0.30),
        hard_timeout_minutes=d.get("hard_timeout_minutes", 1800.0),
        breakeven_trigger_pct=d.get("breakeven_trigger_pct", 1.0),
        breakeven_lock_pct=d.get("breakeven_lock_pct", 0.6),
