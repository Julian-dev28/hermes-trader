...
pathia/agents/ that each poll a signal, record it to the shared shadow
...
dependency on anything else in pathia/agents: a leaf module, the same
...
from pathia.models.types import DslExitOverride
