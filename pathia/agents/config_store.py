...
# Use absolute path based on this file's location (pathia project root)
# __file__ = .../pathia/pathia/agents/config_store.py
# Go up 3 levels: agents/ → pathia/ → pathia/
# Override with PATHIA_AGENT_CONFIG_FILE when deploying behind a mounted volume.
_CONFIG_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
CONFIG_PATH = os.environ.get(
    "PATHIA_AGENT_CONFIG_FILE",
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    # restores the unrestricted behaviour. See pathia/agents/universe.py
