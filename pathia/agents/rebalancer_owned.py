...
from pathia.agents.dsl_exit import active_position_coins
import os
from typing import Any, Dict, List, Optional, Set, Tuple

logger = logging.getLogger(__name__)

# State-file base dir: PATHIA_STATE_DIR (tests/conftest.py points it at a temp dir so the suite
...
_STATE_DIR = os.environ.get("PATHIA_STATE_DIR") or os.path.dirname(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))))


def state_file(name: str) -> str:
    """Absolute path for a rebalancer state file, under PATHIA_STATE_DIR (tests) or the project root."""
