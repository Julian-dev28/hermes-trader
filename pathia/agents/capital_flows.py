...
from pathia.agents.atomic_io import append_json_line

logger = logging.getLogger(__name__)

_STATE_DIR = os.environ.get("PATHIA_STATE_DIR") or os.path.join(
...
def _flows_path() -> str:
    """Resolved at call time so tests can point PATHIA_STATE_DIR at a tmp dir."""
    base = os.environ.get("PATHIA_STATE_DIR")
